          ...
          <div class="col-lg-12 tm-content-box">
            <h2 class="text-white text-center mb-4 tm-section-title">Real Estates</h2>
              <p class="mx-auto tm-section-desc text-center">
                Given below are all the real estates available in qatar. They are of different locations.
              </p>
              <div class="row">
        ...
        <div class="row">
          <div class="col-lg-12 tm-content-box">
            <h2 class="text-white text-center mb-4 tm-section-title">Apartments</h2>
              <p class="mx-auto tm-section-desc text-center">
                Given below are all the Apartments available in qatar. They are of different locations.
              </p>
              <div class="row">
                ...
                foreach ($apartments as $app) {
                  ...
                  if($check == 0){
                    echo "<div class='column'>
                        ...
                        <blockquote><a href='details.php?id=$app->re_id'>Show Details</a></blockquote>
                    </div>";
                  }
                }
                ?>
        ...
        <div class="row">
          <div class="col-lg-12 tm-content-box">
            <h2 class="text-white text-center mb-4 tm-section-title">House</h2>
              <p class="mx-auto tm-section-desc text-center">
                Given below are all the Houses available in qatar. They are of different locations.
              </p>
              <div class="row">
                ...
                foreach ($houses as $hou) {
                  ...
                  if($check == 0){
                    echo "<div class='column'>
                        ...
                        <blockquote><a href='details.php?id=$hou->re_id'>Show Details</a></blockquote>
                    </div>";
                  }
                }
                ?>
        ...
        <div class="row">
          <div class="col-lg-12 tm-content-box">
            <h2 class="text-white text-center mb-4 tm-section-title">Compound Villa</h2>
              <p class="mx-auto tm-section-desc text-center">
                Given below are all the Compound Villas available in qatar. They are of different locations.
              </p>
              <div class="row">
                <?php
                foreach ($compounds as $com) {
                  ...
                  if($check == 0){
                    echo "<div class='column'>
                        ...
                        <blockquote><a href='details.php?id=$com->re_id'>Show Details</a></blockquote>
                    </div>";
                  }
                }
                ?>
        ...
        <div class="row">
          <div class="col-lg-12 tm-content-box">
            <h2 class="text-white text-center mb-4 tm-section-title">Islands</h2>
              <p class="mx-auto tm-section-desc text-center">
                Given below are all the Islands available in qatar. They are of different locations.
              </p>
                ...
                foreach ($islands as $is) {
                  ...
                  if($check == 0){
                    echo "<div class='column'>
                        ...
                        <blockquote><a href='details.php?id=$is->re_id'>Show Details</a></blockquote>
                    </div>";
                  }
                }
                ?>
