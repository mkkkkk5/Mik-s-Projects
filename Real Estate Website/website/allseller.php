<title>Qatar Real Estate Company</title><?php 
  ...
  $getSeller->execute();
  $res = $getSeller->fetchAll(PDO::FETCH_OBJ);
    ...
    <section id="infinite" class="text-white tm-font-big tm-parallax">
      ...
      <div class="text-center tm-hero-text-container">
        <div class="tm-hero-text-container-inner">
            <h2 class="tm-hero-title">Sellers</h2>
        </div>        
      </div>   
    </section>
      ...
      <div class="container tm-testimonials-content">
        <div class="row">
          <div class="col-lg-12 tm-content-box">
            <h2 class="text-white text-center mb-4 tm-section-title">Sellers</h2>
              <p class="mx-auto tm-section-desc text-center">
                Given below are all the sellers available in Qatar.
              </p>
              <div class="row">
                <?php
                    ...
                    foreach ($res as $re) {
                      if ($pA->person_id == $re->person_id) {
                        echo "<div class='column'>
                          <blockquote>Seller Information: </blockquote>
                          ...
                          <blockquote>House Address - $re->selling_house_address </blockquote>
                        </div>";
                      }
                    }
                  }
