    ...
    <body>
        <div id="container">
            ...
            <div id="box">
                ...
                ?><br>
                <p>Mount Everest is Earth's highest mountain above sea level, located in the Mahalangur Himal sub-range of the Himalayas. The international border between Nepal and China runs across its summit point.</p><br>
                Elevation: 8,848 m<br>
                Location: China<br>
                <h1>Reviews</h1>
                <?php 
