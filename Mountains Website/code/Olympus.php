    ...
    <body>
        <div id="container">
            ...
            <div id="box">
                ...
                ?><br>
                <p>Mount Olympus is the highest mountain in Greece. It is located in the Olympus Range on the border between Thessaly and Macedonia, between the regional units of Pieria and Larissa, about 80 km southwest from Thessaloniki. Mount Olympus has 52 peaks and deep gorges.</p><br>
                Elevation: 2,918 m<br>
                Location: Greece<br>
                <?php 
