...
namespace WhatsInMyBag.Controllers
{
    ...
    public class ShipmentsController : Controller
    {
        ...
        {
            var shipments = db.Shipments.Include(s => s.Cart);
        ...
        public ActionResult Create([Bind(Include = "Id,ShipmentFee,TotalFee,CartId")] Shipment shipment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ShipmentFee,TotalFee,CartId")] Shipment shipment)
        {
            if (ModelState.IsValid)
            {
